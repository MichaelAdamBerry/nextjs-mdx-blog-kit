...
The App component will need to track the state of the user so using the useState.
...
Check out the [Code Sandbox](https://codesandbox.io/s/usecontext-example-hs0sh).
