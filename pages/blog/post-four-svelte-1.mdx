...
## Learning Svelte - Part One

This is the first post in a series about my journey learning Svelte. I'm certainly not a Svelte expert yet, but I've worked through the tutorial in the official docs and am working on an survey application. As such, this first post is in some ways more about React, the reasons I'm interested in learning a new approach, and my first impressions of Svelte
...
- Svelte's not actually new. Version 1 was released \_\_\_\_. It's getting a lot of attention recently because Svelte 3.0 was released in the Spring and the team obviously feels like it's in a stable place.
